    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 group flex items-center gap-2 bg-[#14141A] hover:bg-[#C9A96E] text-white rounded-full shadow-lg pl-4 pr-5 py-3 transition-colors"
