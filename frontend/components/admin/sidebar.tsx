...
const NAV: Array<{ label: string; href: string; icon: React.ComponentType<{ className?: string }> }> = [
  ...
  { label: "Talepler", href: "/admin/inquiries", icon: Inbox },
  { label: "Sohbet", href: "/admin/chat", icon: MessagesSquare },
  { label: "AI Yardımcı", href: "/admin/ai", icon: Sparkles },
  { label: "Ayarlar", href: "/admin/settings", icon: Settings },
  { label: "Güvenlik", href: "/admin/audit", icon: History },
];
